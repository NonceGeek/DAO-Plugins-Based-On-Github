defmodule DAOPanelWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DAOPanelWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DAOPanelWeb.Gettext, "errors", msg, opts)
    end
  end
